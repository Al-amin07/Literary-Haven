...
const WishedBook = ({book}) => {
    ...
    return (
        <div className="flex gap-8 my-12 border-2 p-6 rounded-2xl">
        <div className="bg-[#F3F3F3] py-8 px-16 rounded-xl">
            <img className="h-[172px] w-[120px]" src={image} alt="" />
        </div>
        <div>
         ...
         <div className='flex gap-12 border-b-2 pb-5 '>
            ...
            <div className='flex gap-5 mt-4'>
                ...
                <button onClick={handleDetails}  className='text-white bg-[#23BE0A] rounded-full py-3 px-6 font-bold'>View Details</button>
            </div>
        </div>
      </div>
    );
